"""
TVSquared - Prenuvo ResponseReport Export
Exports ResponseReport for previous broadcast week
"""
...
def main():
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            print(f"\n❌ [ERROR] {str(e)}")
            page.screenshot(path="prenuvo_response_error.png")
            raise
        finally:
            time.sleep(2)
            browser.close()
